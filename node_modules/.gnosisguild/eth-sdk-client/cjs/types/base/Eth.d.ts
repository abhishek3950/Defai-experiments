import type { Addressable, BaseContract, BigNumberish, BytesLike, FunctionFragment, Result, Interface, EventFragment, AddressLike, ContractRunner, ContractMethod, Listener } from "ethers";
...
export interface Eth extends BaseContract {
    ...
    attach(target: string | Addressable): Eth;
