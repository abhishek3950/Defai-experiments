import type { Addressable, BaseContract, BytesLike, FunctionFragment, Result, Interface, EventFragment, AddressLike, ContractRunner, ContractMethod, Listener } from "ethers";
...
export interface Usdc extends BaseContract {
    ...
    attach(target: string | Addressable): Usdc;
