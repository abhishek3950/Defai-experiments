...
import type { PermissionLoader, PermissionLoaderInterface } from "../../contracts/PermissionLoader";
export declare class PermissionLoader__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): PermissionLoader;
}
