...
import type { PermissionBuilder, PermissionBuilderInterface } from "../../contracts/PermissionBuilder";
export declare class PermissionBuilder__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): PermissionBuilder;
}
