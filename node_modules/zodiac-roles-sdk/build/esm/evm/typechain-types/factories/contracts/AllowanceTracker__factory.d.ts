...
import type { AllowanceTracker, AllowanceTrackerInterface } from "../../contracts/AllowanceTracker";
export declare class AllowanceTracker__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): AllowanceTracker;
}
