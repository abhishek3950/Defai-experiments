...
export interface TestAvatarInterface extends Interface {
    getFunction(nameOrSignature: "exec" | "execTransactionFromModule" | "execTransactionFromModuleReturnData"): FunctionFragment;
    encodeFunctionData(functionFragment: "exec", values: [AddressLike, BigNumberish, BytesLike, BigNumberish]): string;
...
export interface TestAvatar extends BaseContract {
    ...
    getFunction(nameOrSignature: "exec"): TypedContractMethod<[
        to: AddressLike,
        value: BigNumberish,
        data: BytesLike,
        operation: BigNumberish
