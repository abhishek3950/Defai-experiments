...
import { processPermissions, reconstructPermissions, diffTargets, splitTargets,
...
export const processAnnotations = async (permissions, annotations, options = {}) => {
    ...
    const { targets: targetsViaPresets } = processPermissions(confirmedPresets.flatMap((preset) => preset.permissions));
...
export const resolveAnnotation = async (annotation, { fetchPermissions, fetchSchema, }) => {
