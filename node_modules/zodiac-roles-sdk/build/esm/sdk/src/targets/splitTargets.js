 ...
 */
export const splitTargets = (combined, split) => {
    ...
    return remainder
        ...
        return {
            ...
            functions: target.functions.map((func) => {
                ...
                const remainderCondition = splitCondition(normalizeCondition(func.condition), normalizeCondition(funcInSplit.condition));
