 ...
 */
export const every = (elementScoping) => (abiType) => {
 ...
 * @param elementScoping The condition on the array elements
 */
export const some = (elementScoping) => (abiType) => {
    if (abiType.baseType !== "array") {
 ...
 */
export const subset = (elementScopings) => (abiType) => {
    if (abiType.baseType !== "array") {
    ...
    return {
        ...
        children: elementScopings.map((elementScoping) => {
            ...
            return mapScoping(elementScoping, abiType.arrayChildren); // cast is safe because of earlier elementScoping check
        }),
    };
};
