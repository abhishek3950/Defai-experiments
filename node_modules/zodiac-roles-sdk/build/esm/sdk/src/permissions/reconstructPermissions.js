import { Clearance, ExecutionOptions, Operator, } from "zodiac-roles-deployments";
/**
 ...
 */
export const reconstructPermissions = (targets) => {
...
const allowsSend = (execOptions) => execOptions === ExecutionOptions.Send || execOptions === ExecutionOptions.Both;
const allowsDelegateCall = (execOptions) => execOptions === ExecutionOptions.DelegateCall ||
