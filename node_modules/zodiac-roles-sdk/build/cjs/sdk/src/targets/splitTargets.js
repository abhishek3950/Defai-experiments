 ...
 */
const splitTargets = (combined, split) => {
    const remainder = (0, diffTargets_1.diffTargets)(combined, split);
    ...
    return remainder
        ...
        if (!targetInSplit)
            return target;
        return Object.assign(Object.assign({}, target), { functions: target.functions.map((func) => {
                const funcInSplit = targetInSplit.functions.find((f) => f.selector === func.selector);
                if (!funcInSplit)
                    return func;
                ...
                const remainderCondition = (0, conditions_1.splitCondition)((0, conditions_1.normalizeCondition)(func.condition), (0, conditions_1.normalizeCondition)(funcInSplit.condition));
                if (!remainderCondition)
                    throw new Error("invariant violation");
                return Object.assign(Object.assign({}, func), { condition: remainderCondition });
            }) });
    })
        .filter(Boolean);
};
exports.splitTargets = splitTargets;
