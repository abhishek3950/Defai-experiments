...
import type { PermissionChecker, PermissionCheckerInterface } from "../../contracts/PermissionChecker";
export declare class PermissionChecker__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): PermissionChecker;
}
