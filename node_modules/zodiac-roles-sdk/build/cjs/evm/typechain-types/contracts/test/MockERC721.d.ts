...
export interface MockERC721Interface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "doSomething" | "getApproved" | "isApprovedForAll" | "mint" | "name" | "ownerOf" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "Transfer"): EventFragment;
    encodeFunctionData(functionFragment: "approve", values: [AddressLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "balanceOf", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "doSomething", values: [BigNumberish, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "doSomething", data: BytesLike): Result;
...
export interface MockERC721 extends BaseContract {
    ...
    getFunction(nameOrSignature: "doSomething"): TypedContractMethod<[
        tokenId: BigNumberish,
        someParam: BigNumberish
    ], [
        void
